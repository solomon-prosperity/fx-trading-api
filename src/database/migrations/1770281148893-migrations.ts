...
export class Migrations1770281148893 implements MigrationInterface {
  name = 'Migrations1770281148893';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "transaction" ("transaction_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "wallet_id" character varying NOT NULL, "session_id" character varying, "currency" character varying NOT NULL, "reference" character varying NOT NULL, "amount" integer NOT NULL, "description" character varying NOT NULL, "status" "public"."transaction_status_enum" NOT NULL DEFAULT 'pending', "type" "public"."transaction_type_enum" NOT NULL DEFAULT 'funding', "exchange_rate" numeric(18,8) NOT NULL, "flow" "public"."transaction_flow_enum" NOT NULL, "is_transfer" boolean NOT NULL DEFAULT false, "is_disputed" boolean NOT NULL DEFAULT false, "dispute_details" text, "dispute_resources" text, "metadata" json, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_6e02e5a0a6a7400e1c944d1e946" PRIMARY KEY ("transaction_id"))`,
    );
    await queryRunner.query(
